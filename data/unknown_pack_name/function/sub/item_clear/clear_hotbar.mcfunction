...
$execute if items entity @s hotbar.$(slot) stone[custom_data~{ancient_tablet:1b,tablet_uses:3}] run item modify entity @s hotbar.$(slot) unknown_pack_name:clean_tablet_data
$execute if items entity @s hotbar.$(slot) stone[custom_data~{ancient_tablet:1b,tablet_uses:2}] run item modify entity @s hotbar.$(slot) unknown_pack_name:clean_tablet_data
$execute if items entity @s hotbar.$(slot) stone[custom_data~{ancient_tablet:1b,tablet_uses:1}] run item modify entity @s hotbar.$(slot) unknown_pack_name:clean_tablet_data
