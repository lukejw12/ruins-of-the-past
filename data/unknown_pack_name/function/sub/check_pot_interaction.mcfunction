...
execute if data entity @s data.stored_item.components."minecraft:custom_data".linked_storage if data entity @s interaction run function unknown_pack_name:core/block/placed/pot/linked_storage/handle_click
