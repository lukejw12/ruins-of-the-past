...
execute store result storage unknown_pack_name:temp remaining_levels int 1 run scoreboard players get #remaining_player_levels temp
function unknown_pack_name:transcriber/set_player_experience with storage unknown_pack_name:temp
