...
$execute if score #found_target temp matches 1 run positioned ~$(x) ~$(y) ~$(z) run function unknown_pack_name:core/block/placed/table/place_table
...
$execute if score #found_target temp matches 1 run positioned ~$(x) ~$(y) ~$(z) run function unknown_pack_name:core/block/placed/table/place_rune_table
execute if score #found_target temp matches 1 run return 0

$execute if block ~$(x) ~$(y) ~$(z) smoker run scoreboard players set #found_target temp 1
$execute if score #found_target temp matches 1 run positioned ~$(x) ~$(y) ~$(z) run function unknown_pack_name:core/block/placed/pottery_wheel/place_pottery_wheel
execute if score #found_target temp matches 1 run return 0
