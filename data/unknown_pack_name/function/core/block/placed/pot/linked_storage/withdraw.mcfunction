...
function unknown_pack_name:core/block/placed/pot/linked_storage/get_stored_item_data with storage unknown_pack_name:temp
...
function unknown_pack_name:core/block/placed/pot/linked_storage/spawn_item with storage unknown_pack_name:temp
...
function unknown_pack_name:core/block/placed/pot/linked_storage/update_count with storage unknown_pack_name:temp

execute if score #stored_count temp matches 0 run function unknown_pack_name:core/block/placed/pot/linked_storage/clear_storage with storage unknown_pack_name:temp
