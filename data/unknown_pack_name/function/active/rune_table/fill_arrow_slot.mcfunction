...
$execute if score #has_item temp matches 1 if score #has_rune temp matches 1 if score #has_transcriber temp matches 1 run function unknown_pack_name:active/rune_table/update_arrow_slot {slot:$(slot)}
$execute unless score #has_item temp matches 1 run function unknown_pack_name:active/rune_table/show_empty_arrow {slot:$(slot)}
$execute unless score #has_rune temp matches 1 run function unknown_pack_name:active/rune_table/show_empty_arrow {slot:$(slot)}
$execute unless score #has_transcriber temp matches 1 run function unknown_pack_name:active/rune_table/show_empty_arrow {slot:$(slot)}
