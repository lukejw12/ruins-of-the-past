...
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:golden_helmet"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:diamond_helmet"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:netherite_helmet"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:turtle_helmet"} run scoreboard players set #compatible temp 1
...
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:leather_boots"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:chainmail_boots"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:iron_boots"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:golden_boots"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:diamond_boots"} run scoreboard players set #compatible temp 1
execute if data storage unknown_pack_name:temp input_item{id:"minecraft:netherite_boots"} run scoreboard players set #compatible temp 1