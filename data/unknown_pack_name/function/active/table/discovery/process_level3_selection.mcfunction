...
execute if data storage unknown_pack_name:discovery selected{discovery_rarity:"epic"} run data modify storage unknown_pack_name:discovery rarity set value "epic"
