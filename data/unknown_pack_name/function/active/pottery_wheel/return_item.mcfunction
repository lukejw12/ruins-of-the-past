...
execute if data storage unknown_pack_name:temp return_item.components."minecraft:custom_data"{pot_item:1b} run function unknown_pack_name:active/pottery_wheel/consume_crafting_materials
