...
execute if score #south_filled temp matches 1 if score #north_filled temp matches 1 if score #west_filled temp matches 1 if score #east_filled temp matches 1 if items block ~ ~ ~ container.10 ender_eye unless items block ~ ~ ~ container.10 bundle unless items block ~ ~ ~ container.10 tnt run function unknown_pack_name:core/block/placed/pot/linked_storage/show_result
execute if score #south_filled temp matches 1 if score #north_filled temp matches 1 if score #west_filled temp matches 1 if score #east_filled temp matches 1 unless items block ~ ~ ~ container.10 bundle unless items block ~ ~ ~ container.10 tnt unless items block ~ ~ ~ container.10 ender_eye run function unknown_pack_name:active/pottery_wheel/show_custom_pot_result
