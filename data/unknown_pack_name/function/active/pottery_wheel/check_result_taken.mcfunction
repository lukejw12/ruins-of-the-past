...
execute if score @s has_result matches 4 if score #current_has_result temp matches 0..3 run function unknown_pack_name:active/pottery_wheel/consume_crafting_materials
