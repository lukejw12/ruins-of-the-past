...
data modify entity @e[tag=temp_item_convert,limit=1] Item set from entity @s SelectedItem
...
item replace entity @s weapon.mainhand from entity @e[tag=temp_item_convert,limit=1] container.0
