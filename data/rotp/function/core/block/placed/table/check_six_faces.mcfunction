execute if block ~0.1 ~ ~ loom positioned ~0.1 ~ ~ run function rotp:core/block/placed/table/place_table
...
execute if block ~0.1 ~ ~ lodestone positioned ~0.1 ~ ~ run function rotp:core/block/placed/pedestal/spawn_pedestal_display
