...
execute if data storage rotp:temp player_item.components."minecraft:custom_data".pedestal_placable run advancement grant @a[tag=pedestal_interact,limit=1,sort=nearest] only rotp:core/pedestal_4x
