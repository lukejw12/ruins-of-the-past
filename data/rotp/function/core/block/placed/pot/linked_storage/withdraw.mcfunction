...
function rotp:core/block/placed/pot/linked_storage/get_stored_item_data with storage rotp:temp
execute store result storage rotp:temp stored_item_data.count int 1 run scoreboard players get #withdraw_amount temp

function rotp:core/block/placed/pot/linked_storage/spawn_item with storage rotp:temp
...
function rotp:core/block/placed/pot/linked_storage/update_count with storage rotp:temp

execute if score #stored_count temp matches 0 run function rotp:core/block/placed/pot/linked_storage/clear_storage with storage rotp:temp
