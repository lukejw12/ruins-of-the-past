...
execute if data storage rotp:temp pot_data{pot_type:"thin"} run summon item_display ~ ~ ~ {item:{id:"barrier",components:{item_model:"rotp:pottery/pot_type_thin"}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["pot_display","pot_base","needs_id"]}

execute if data storage rotp:temp pot_data{pot_type:"slab"} run summon item_display ~ ~ ~ {item:{id:"barrier",components:{item_model:"rotp:pottery/pot_type_slab"}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["pot_display","pot_base","needs_id"]}

execute if data storage rotp:temp pot_data{pot_type:"small"} run summon item_display ~ ~ ~ {item:{id:"barrier",components:{item_model:"rotp:pottery/pot_type_small"}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["pot_display","pot_base","needs_id"]}

execute if data storage rotp:temp pot_data{pot_type:"square"} run summon item_display ~ ~ ~ {item:{id:"barrier",components:{item_model:"rotp:pottery/pot_type_square"}},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},Tags:["pot_display","pot_base","needs_id"]}
...
execute as @e[tag=pot_interaction,distance=..1,limit=1] run data modify entity @s data.stored_item set from storage rotp:temp original_item_data
