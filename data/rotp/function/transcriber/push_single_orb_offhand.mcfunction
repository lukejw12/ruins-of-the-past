execute store result score #px temp run data get entity @p[distance=..1] Pos[0] 1000
execute store result score #py temp run data get entity @p[distance=..1] Pos[1] 1000
execute store result score #pz temp run data get entity @p[distance=..1] Pos[2] 1000
...
scoreboard players set #push_strength temp 60
