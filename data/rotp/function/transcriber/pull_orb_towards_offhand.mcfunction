execute store result score #dx temp run data get entity @p[distance=..6] Pos[0] 1000
execute store result score #dy temp run data get entity @p[distance=..6] Pos[1] 1000
execute store result score #dz temp run data get entity @p[distance=..6] Pos[2] 1000
...
scoreboard players set #speed temp 40
