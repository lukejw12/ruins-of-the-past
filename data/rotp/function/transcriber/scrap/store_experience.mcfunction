...
execute store result score #player_leftover_points temp run experience query @s points

scoreboard players operation #target_level temp = #player_levels temp
function rotp:transcriber/conversion/levels_to_points
scoreboard players operation #player_total_points temp = #output_points temp
scoreboard players operation #player_total_points temp += #player_leftover_points temp
...
scoreboard players reset #player_leftover_points temp
