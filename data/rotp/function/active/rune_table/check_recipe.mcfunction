...
execute if score #can_craft temp matches 1 run function rotp:active/rune_table/show_result
execute unless score #can_craft temp matches 1 run function rotp:active/rune_table/clear_result
