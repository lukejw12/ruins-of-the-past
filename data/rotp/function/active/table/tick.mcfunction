...
execute if items block ~ ~ ~ container.10 stone[custom_data={ancient_tablet:1b}] if data storage rotp:discovery type run function rotp:active/table/recipes/ancient_tablet_clear_results
execute if items block ~ ~ ~ container.10 stone[custom_data={ancient_tablet:1b}] if data storage rotp:discovery type run data remove storage rotp:discovery type
data merge block ~ ~ ~ {CustomName:"Research Workbench"}
scoreboard players operation #previous_tablet temp = #tablet_present temp
execute unless score #stop temp matches 1.. if items block ~ ~ ~ container.10 stone[custom_data~{ancient_tablet:1b}] if items block ~ ~ ~ container.11 spyglass unless data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:custom_data".discovery_level run function rotp:active/table/recipes/ancient_tablet_valid
execute unless score @s completion_delay matches 1.. if items block ~ ~ ~ container.10 stone[custom_data~{ancient_tablet:1b}] if items block ~ ~ ~ container.11 spyglass if data block ~ ~ ~ Items[{Slot:10b}].components."minecraft:custom_data".discovery_level run function rotp:active/table/discovery/check_discovery_click
