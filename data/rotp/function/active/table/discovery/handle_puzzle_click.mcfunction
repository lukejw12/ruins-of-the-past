...
execute unless score #clicked_slot temp matches -1 run function rotp:active/table/discovery/process_puzzle_click
execute unless score #cliced_slot temp matches -1 run function rotp:active/table/discovery/place_puzzle_pieces
