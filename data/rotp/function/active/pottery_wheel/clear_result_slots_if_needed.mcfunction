...
execute if score @s recipe_state matches 1 if score #recipe_filled temp matches 0 run item replace block ~ ~ ~ container.13 with air
execute if score @s recipe_state matches 1 if score #recipe_filled temp matches 0 run item replace block ~ ~ ~ container.14 with air
