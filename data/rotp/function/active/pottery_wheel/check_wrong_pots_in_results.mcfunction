execute if items block ~ ~ ~ container.4 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.4 structure_void[custom_data~{pot_type:"thin"}] run function rotp:active/pottery_wheel/return_item {slot:4}
execute if items block ~ ~ ~ container.4 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.4 structure_void[custom_data~{pot_type:"thin"}] run function rotp:active/pottery_wheel/consume_crafting_materials

execute if items block ~ ~ ~ container.5 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.5 structure_void[custom_data~{pot_type:"slab"}] run function rotp:active/pottery_wheel/return_item {slot:5}
execute if items block ~ ~ ~ container.5 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.5 structure_void[custom_data~{pot_type:"slab"}] run function rotp:active/pottery_wheel/consume_crafting_materials

execute if items block ~ ~ ~ container.6 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.6 structure_void[custom_data~{pot_type:"small"}] run function rotp:active/pottery_wheel/return_item {slot:6}
execute if items block ~ ~ ~ container.6 structure_void[custom_data~{pot_item:1b}] unless items block ~ ~ ~ container.6 structure_void[custom_data~{pot_type:"small"}] run function rotp:active/pottery_wheel/consume_crafting_materials
